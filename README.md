# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Retail Procurement Payments
...
```shell
composer require bricre/amazon-selling-partner-sdk-vendor-invoices
```
...
```php
<?php
use Amz\VendorInvoices\ResponseTypes;
